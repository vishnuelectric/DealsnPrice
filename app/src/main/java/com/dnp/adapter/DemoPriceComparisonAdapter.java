...
public class DemoPriceComparisonAdapter extends ArrayAdapter<DealBean>{
	Context cxt;
	private LayoutInflater mInflater;
	ImageLoader image_load;
	DisplayImageOptions opt;
	public DemoPriceComparisonAdapter(Context context, ArrayList<DealBean> value) {
	...
	public View getView(int position, View convertView, ViewGroup parent) {
		...
		holder.category_image=(ImageView) convertView.findViewById(R.id.product_image);
		holder.store_image=(ImageView) convertView.findViewById(R.id.store_image);
		holder.cut_text=(View) convertView.findViewById(R.id.cut_text);
